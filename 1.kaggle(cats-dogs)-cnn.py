...
os.chdir('D:\\Data Science\\deeplearning\\Python scripts\\kaggle-cats vs dogs')
import utils
...
history = model.fit_generator(train_generator, steps_per_epoch=2000//batch_size, epochs=2, validation_data=validation_generator, 
