...
import pydot #To use any external .exe files.... Here we are using dot.exe

os.environ["PATH"] += os.pathsep + 'C:/Program Files (x86)/Graphviz2.38/bin/' #Environmental variable path
