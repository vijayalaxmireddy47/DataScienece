...
lr_grid = {'C':list(np.arange(0.01,0.1,0.02)), 'penalty':['l1', 'l2'], 'max_iter':list(range(20, 51, 10))}
...
lr_grid_estimator.best_score_ # 0.79573512906846244
print(lr_grid_estimator.score(X_train, y_train)) #0.796857463524
